...
export const createMoodLog = async (req, res) => {
    try {
        const { date, mood, intensity, energyLevel, sleepQuality, sleepHours, stressLevel, notes } =
            req.body;
...
export const getMoodLogs = async (req, res) => {
    try {
        ...
        const logs = await MoodLog.getUserHistory(req.user._id, startDate, endDate);
...
export const updateMoodLog = async (req, res) => {
    try {
        const { mood, intensity, energyLevel, sleepQuality, sleepHours, stressLevel, notes } =
            req.body;
