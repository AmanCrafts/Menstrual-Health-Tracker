            ...
            <div className="auth-card">
                ...
                <div className="auth-branding">
                    ...
                    <div className="auth-branding-content">
                        ...
                        <p className="auth-branding-text">
                            Join thousands who have taken control of their menstrual health.
                            Create your free account and discover personalized insights
                ...
                <div className="auth-form-side">
                    ...
                    <div className="auth-privacy">
                        ...
                        <p>By creating an account, you agree to keep your health data private and secure.</p>
                    </div>
